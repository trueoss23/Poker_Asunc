...
def compare_two_combs(h1, h2):
    comb_one = get_comb_details(h1)
    comb_two = get_comb_details(h2)
...
def get_comb_details(comb: str) -> tuple:
...
def calc_options():
    for i in range(50_000):
        compare_two_combs('2c 5c 3c 4c 5h 7c Ad', 'Ac Ac 3c 4c 5h 7c 6d')
